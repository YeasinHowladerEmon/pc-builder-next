        ...
        <>
            <footer className="container mx-auto footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a className="link link-hover">Motherboard</a>
                    <a className="link link-hover">Processor</a>
                    <a className="link link-hover">Ram</a>
                    <a className="link link-hover">Storage</a>
                </nav>
                <nav>
                    <header className="footer-title">Login</header>
            ...
            </footer><footer className="container mx-auto footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>PC BUILDER Ltd. <br />Providing reliable tech since 2000</p>
                </aside>
